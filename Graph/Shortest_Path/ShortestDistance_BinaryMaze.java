...
public class ShortestDistance_BinaryMaze {
    ...
    public static int shortestPath(int[][] grid, int[] source, int[] destination) {
        ...
        // Create a queue for storing cells with their distances from source in the form {dist, {cell coordinates pair}}.
        ...
        // The following delta rows and delts columns array are created such that each index represents each adjacent node that a cell may have in a direction.
        int dr[] = {-1, 0, 1, 0}; 
        int dc[] = {0, 1, 0, -1}; 
        ...
        while(!q.isEmpty()) {
            ...
            for(int i = 0;i<4;i++) {
                ...
                if(newr >= 0 && newr < n && newc >= 0 && newc < m && grid[newr][newc] == 1 && dis + 1 < dist[newr][newc]) {
                    ...
                    // Return the distance until the point when we encounter the destination cell.
